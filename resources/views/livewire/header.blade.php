                ...
                <div class="ml-3 relative">
                    <div>
                        <button type="button"
                            ...
                            <img class="h-8 w-8 rounded-full bg-cover"
                                 src="https://images.unsplash.com/photo-1522556189639-b150ed9c4330?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80"
                                 alt="">
                        </button>
                    </div>
                </div>
